      ...
      initData: async (knex) => {
        await knex("o_agentDeploy").insert([
          ...
          },
          {
            ...
            modelName: "",
            vendorId: null,
            key: "oneSentenceAgent",
            name: "一句话Agent",
            desc: "一句话入口Agent，用于引导用户确认风格和细节",
            disabled: false,
          },
          {
            model: "",
            modelName: "",
            vendorId: null,
            key: "oneSentenceAgent:decisionAgent",
            name: "一句话Agent:决策层",
            desc: "决策层",
            temperature: 1,
            maxOutputTokens: 0,
        ...
        await knex("o_vendorConfig").insert([
          ...
          },
          {
            ...
            models: JSON.stringify([
              ...
              { name: "DeepSeek V4 Pro (Thinking)", modelName: "deepseek-v4-pro", type: "text", think: true },
              { name: "Claude Opus 4.6", modelName: "claude-4.6-opus", type: "text", think: false },
              ...
              { name: "Agnes Video 1.0", modelName: "agnes-video-1.0", type: "video", mode: ["singleImage"], audio: "optional", durationResolutionMap: [{ duration: [5, 10, 15], resolution: ["1080x1920", "1920x1080"] }] },
              { name: "Agnes TTS", modelName: "agnes-tts-1", type: "tts", voices: [{ title: "中文女声", voice: "zh-CN-XiaoxiaoNeural" }, { title: "中文男声", voice: "zh-CN-YunxiNeural" }] },
            ]),
            enable: 1,
          },
        ]);
